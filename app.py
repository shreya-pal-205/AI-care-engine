...
def image_to_text(img):
    response = model.generate_content(["Tell me how to take care of this thing that is present in the image", img])
...
# app create==============
st.title("Empowering Lives Through Compassionate Support.")
